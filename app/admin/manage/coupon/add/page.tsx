...
import { createCoupon } from '@/lib/apis/admin';
...
export default function AdminCouponAdd() {
	...
	var [partnerId, setPartnerId] = useState("kejgogo");
			...
			<div>
				<dl>
					...
					<dd><input type="text" placeholder="입력해 주세요." name="partnerId"
						value={partnerId} onChange={(e: React.ChangeEvent<HTMLInputElement>) => { setPartnerId(e.target.value) }} /></dd>
				</dl>
				<dl>
					<dt>쿠폰명</dt>
